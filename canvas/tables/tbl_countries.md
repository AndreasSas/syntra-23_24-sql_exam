...
| ----------- | ---------------- | ----- |
| id          | nvarchar(3)       | PK UQ NN |
| name_nl     | nvarchar(64)      | UQ NN    |

---
```sql
INSERT INTO tbl_countries (id, name_nl)  
VALUES  
    ('ABW', 'Aruba'),  
    ('AFG', 'Afghanistan'),  
    ('AGO', 'Angola'),  
    ...
    ('UGA', 'Oeganda'),  
    ('UKR', 'Oekraïne'),  
    ('UMI', 'Amerikaanse Kleinere Afgelegen Eilanden'),  
    ('URY', 'Uruguay'),  
