...
// src/setting_tab/components/ComponentCSS.ts
var import_obsidian = require("obsidian");
var ComponentCSS = class extends SettingsTabComponent {
  create_component(containerEL) {
    new import_obsidian.Setting(containerEL).setName("Enable extra CSS options").addToggle(
      (component) => {
        component.setValue(this.plugin.settings.CSS.Enable).onChange(async (state) => {
...
// src/setting_tab/components/ComponentCSSTagsNoWrap.ts
...
var ComponentDebug = class extends SettingsTabComponent {
  create_component(containerEL) {
    new import_obsidian3.Setting(containerEL).setName("Enable debug options").setDesc(`
...
var ComponentDebugReloadCSS = class extends SettingsTabComponent {
  ...
  // -----------------------------------------------------------------------------------------------------------------
  create_component(containerEL) {
    new import_obsidian4.Setting(containerEL).setName("Refresh CSS styling").setDesc(`
...
var ComponentFolderNote = class extends SettingsTabComponent {
  ...
  // -----------------------------------------------------------------------------------------------------------------
  create_component(containerEL) {
    new import_obsidian5.Setting(containerEL).setName("Enable Folder Note integration").setDesc(`
...
var ComponentFolderNoteAutoDetect = class extends SettingsTabComponent {
  ...
  // -----------------------------------------------------------------------------------------------------------------
  create_component(containerEL) {
    new import_obsidian6.Setting(containerEL).setName("Enable auto detection").setDesc("Auto detects changes in a file's property's tags and updates the file viewer.").addToggle(
      (component) => {
...
var ComponentFolderNoteDetect = class extends SettingsTabComponent {
  ...
  // -----------------------------------------------------------------------------------------------------------------
  create_component(containerEL) {
    new import_obsidian7.Setting(containerEL).setName("Detect tags in folder notes").setDesc(`Traverses your vault and stores all tags found in notes with the same name as the folder they are found in.`).addButton(
...
var ComponentFolderNoteFolderTagLinks = class extends SettingsTabComponent {
  ...
  // -----------------------------------------------------------------------------------------------------------------
  create_component(containerEL) {
    let setting = new import_obsidian8.Setting(containerEL).setName("Top Level Folder ").setDesc(`Define custom colors for tags.`).addButton(
  ...
  _createFolderTagLinks(linkUUID, link_content, containerEL) {
    ...
    const setting = new import_obsidian8.Setting(containerEL).addText(
...
var ComponentKanban = class extends SettingsTabComponent {
  ...
  // -----------------------------------------------------------------------------------------------------------------
  create_component(containerEL) {
    new import_obsidian9.Setting(containerEL).setName("Enable Kanban integration").addToggle(
      (component) => {
...
var ComponentKanbanCards = class extends SettingsTabComponent {
  ...
  // -----------------------------------------------------------------------------------------------------------------
  create_component(containerEL) {
    new import_obsidian10.Setting(containerEL).setName("Apply tag color to kanban card").setDesc(`
...
var ComponentKanbanHideHashtags = class extends SettingsTabComponent {
  ...
  // -----------------------------------------------------------------------------------------------------------------
  create_component(containerEL) {
    new import_obsidian11.Setting(containerEL).setName("Omit '#' in kanban boards").setDesc(`
...
var ComponentKanbanLists = class extends SettingsTabComponent {
  ...
  // -----------------------------------------------------------------------------------------------------------------
  create_component(containerEL) {
    new import_obsidian12.Setting(containerEL).setName("Apply tag color to kanban list").setDesc(`
...
var ComponentTags = class extends SettingsTabComponent {
  ...
  // -----------------------------------------------------------------------------------------------------------------
  create_component(containerEL) {
    let setting = new import_obsidian13.Setting(containerEL).setName("Custom color tags").setDesc(`Define custom colors for tags.`).addButton((button) => this._add_new_tag_button(button));
    if (this.plugin.settings.Debug.Enable) {
      setting.addButton(
        (button) => button.setButtonText("Clear all").onClick(
          async () => {
    ...
    new import_obsidian13.Setting(containerEL).addButton((button) => this._add_new_tag_button(button));
  }
  // -----------------------------------------------------------------------------------------------------------------
...
var ComponentTagsCanvas = class extends SettingsTabComponent {
  ...
  // -----------------------------------------------------------------------------------------------------------------
  create_component(containerEL) {
    new import_obsidian14.Setting(containerEL).setName("Apply tag color to canvas card").setDesc(`
...
var ComponentTagsEnableBackgroundOpacity = class extends SettingsTabComponent {
  ...
  // -----------------------------------------------------------------------------------------------------------------
  create_component(containerEL) {
    let setting = new import_obsidian15.Setting(containerEL).setName("Enable background opacity").setDesc(`
...
var ComponentTagsEnableDarkLightDifference = class extends SettingsTabComponent {
  ...
  // -----------------------------------------------------------------------------------------------------------------
  create_component(containerEL) {
    new import_obsidian16.Setting(containerEL).setName("Enable different luminance formula for dark & light mode").setDesc(`
...
var ComponentTagsEnableMultipleTags = class extends SettingsTabComponent {
  ...
  // -----------------------------------------------------------------------------------------------------------------
  create_component(containerEL) {
    new import_obsidian17.Setting(containerEL).setName("Enable multiple tags per line").setDesc("Allows the usage of `;` or `\\n` (new line) to bind multiple tags to one color.").addToggle(
      (component) => {
...
var ComponentTagsEnableSeparateBackground = class extends SettingsTabComponent {
  ...
  // -----------------------------------------------------------------------------------------------------------------
  create_component(containerEL) {
    new import_obsidian18.Setting(containerEL).setName("Enable separate background color").setDesc("Allows you to specify a different background color for each tag.").addToggle(
      (component) => {
...
var ComponentTagsEnableSeparateLuminance = class extends SettingsTabComponent {
  ...
  // -----------------------------------------------------------------------------------------------------------------
  create_component(containerEL) {
    new import_obsidian19.Setting(containerEL).setName("Enable separate luminance offsets per tag").setDesc("Allows you to specify a different luminance offset value for each tag. This offset is used in background of items like Canvas Card, Kanban Card/List, ...").addToggle(
      (component) => {
...
// src/style_manager/wranglers/StyleWranglerCSS.ts
var StyleWranglerCSS = class extends StyleWrangler {
  // -----------------------------------------------------------------------------------------------------------------
  // Constructor
  // -----------------------------------------------------------------------------------------------------------------
  constructor(plugin) {
...
var StyleManager = class {
  ...
  switchAllStyles() {
    ...
    this.plugin.settings.CSS.Enable ? this.wrangler_css.apply_styles() : this.wrangler_css.remove_styles();
  }
  // -----------------------------------------------------------------------------------------------------------------
  // applyAllStyles():void {
...
// src/settings/migrations/migrate_8_to_9.ts
function migrate_8_to_9(loaded_data) {
  let transformed_data = loaded_data;
...
// src/main.ts
var ColoredTagWranglerPlugin = class extends import_obsidian21.Plugin {
  // -----------------------------------------------------------------------------------------------------------------
  // Methods
  // -----------------------------------------------------------------------------------------------------------------
  async onload() {
